  ...
  return (
    <>
      ...
      <section className="relative min-h-screen w-full overflow-hidden bg-black">
        ...
        {/* MAIN GRID */}
        <div className="relative z-10 pt-32 pb-20 grid grid-cols-1 lg:grid-cols-[30%_70%] min-h-screen">
          ...
          <div className="flex items-center px-10">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="bg-white text-black rounded-l-[60px] shadow-xl p-16 w-full  overflow-y-auto"
              >
